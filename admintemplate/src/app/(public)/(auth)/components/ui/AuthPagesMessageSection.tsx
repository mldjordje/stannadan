		...
		>
			...
			<div className="relative z-10 w-full max-w-4xl">
				<div className="text-7xl leading-none font-bold text-gray-100">
					<div>Stan na dan</div>
					<div>Nis control room</div>
				</div>
				<div className="mt-6 text-lg leading-6 tracking-tight text-gray-400">
					Jedna prijava otvara javni nalog za goste, istoriju rezervacija i administraciju za kalendar,
					apartmane i Booking.com sync.
				</div>
				<div className="mt-8 flex items-center">
					...
					<div className="ml-4 font-medium tracking-tight text-gray-400">
						Gosti vide svoje rezervacije, a admin tim odmah dobija pristup operativnom panelu
					</div>
				</div>
			</div>
		</Box>
